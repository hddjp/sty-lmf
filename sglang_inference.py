...
def main():
    ...
    save_path = os.path.join("/data2/sty/sty-lmf/saves/qwen3-4b/eval_result/", eval_model)
    save_mode = True
    
    #model_path = f"/data/sty/onff/model/{model_name}/epoch_{epoch}"
    model_path = f"/data2/sty/sty-lmf/saves/qwen3-4b/${model_name}/${epoch}"
    ...
    for ds in all_datasets:
        print(f"Dataset: {ds}")
        dataset = EvalDataset(os.path.join("/data2/sty/sty-lmf/dataset/test", ds + ".jsonl"))
